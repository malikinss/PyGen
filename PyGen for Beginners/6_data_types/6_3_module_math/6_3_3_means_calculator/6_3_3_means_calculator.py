...
TODO:
    In mathematics, the following averages are distinguished:
        ...
        - harmonic mean of numbers a and b:
            (2*a*b)/(a+b)
        - quadratic mean  of numbers a and b:
            sqrt((a^2 + b^2)/2)

    The program should display 4 numbers:
        arithmetic mean, geometric mean, harmonic and quadratic
'''
...
print(arithmetic_mean, geometric_mean,
      harmonic_mean, quadratic_mean, sep='\n')
