...
TODO:
    ...
    You need to write a program that displays the maximum digit of a number
    that is a multiple of 3.

    If there are no digits divisible by 3 in the number, display “NO”
    on the screen.
...
NOTE:
    The number 0 is divisible by any natural number.
