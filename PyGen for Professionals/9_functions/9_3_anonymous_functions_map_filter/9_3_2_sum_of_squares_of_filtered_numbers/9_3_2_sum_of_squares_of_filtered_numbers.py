...
def sum_of_squares_of_filtered_numbers(numbers: List[int]) -> int:
    ...
    """
    # Filter numbers that are two-digit and divisible by 9, then square them
    return sum(
        map(
            lambda x: x ** 2,
            filter(lambda x: 9 < abs(x) < 100 and x % 9 == 0, numbers)
        )
    )
...
numbers = [
    ...
    -1187, -3313, 2741, 4786, -2689, 741, 4558, 1442, 62, -1099, -2201, -16,
    -3115, 1862, 2384, 4072, -90, 204, 1158, -3134, -2512, 756, 4148, 4370,
    1756, 3609, -1148, -3909, 4123, -2906, 69, 96, 1111
]
