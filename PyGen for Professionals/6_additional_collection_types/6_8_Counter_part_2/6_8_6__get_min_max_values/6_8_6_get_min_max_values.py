...
def filter_items_by_specific_value(given_dict: Dict[str, int],
                                   given_value: int) -> List[Tuple[str, int]]:
    """
    ...
    Returns:
        List[Tuple[str, int]]: A list of (key, value) tuples with the
        specified value.
    """
...
def get_max_values(self: Counter) -> List[Tuple[str, int]]:
    """
    Returns a list of elements with the largest value in the Counter.
...
def get_min_values(self: Counter) -> List[Tuple[str, int]]:
    """
    Returns a list of elements with the smallest value in the Counter.
...
Counter.max_values = get_max_values
Counter.min_values = get_min_values