...
def convert_to_json(data: Dict) -> str:
    """
    Converts a dictionary to a JSON string with three-space indentation,
    without replacing Cyrillic characters with their codes.
...
specs_json = convert_to_json(specs)
print(specs_json)
