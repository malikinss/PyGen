...
TODO:
    ...
    The function should return a dictionary in which the key is the name of
    the file column filename, and the value is a list of elements of this
    column.

NOTE:
    It is guaranteed that the file passed to the function is delimited by a
    comma, and quotation marks are not used.

    It is guaranteed that the first line of the file passed to the function
...
def create_empty_dict_with_headers(
